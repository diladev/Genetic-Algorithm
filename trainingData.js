const trainingData = [
    ...
    { input: [1, 0, 0, 1, 0, 0], output: [0] },
    { input: [1, 0, 0, 1, 0, 1], output: [1] },
    { input: [1, 0, 0, 1, 1, 0], output: [1] },
    { input: [1, 0, 0, 1, 1, 1], output: [0] },
    { input: [1, 0, 1, 0, 0, 0], output: [0] },
    { input: [1, 0, 1, 0, 0, 1], output: [1] },
    { input: [1, 0, 1, 0, 1, 0], output: [1] },
    { input: [1, 0, 1, 0, 1, 1], output: [0] },
    { input: [1, 0, 1, 1, 0, 0], output: [1] },
    { input: [1, 0, 1, 1, 0, 1], output: [0] },
    { input: [1, 0, 1, 1, 1, 0], output: [0] },
    { input: [1, 0, 1, 1, 1, 1], output: [1] },
    { input: [1, 1, 0, 0, 0, 0], output: [0] },
    { input: [1, 1, 0, 0, 0, 1], output: [1] },
    { input: [1, 1, 0, 0, 1, 0], output: [1] },
    { input: [1, 1, 0, 0, 1, 1], output: [0] },
    ...
    { input: [1, 1, 1, 0, 0, 1], output: [0] },
    { input: [1, 1, 1, 0, 1, 0], output: [0] },
    { input: [1, 1, 1, 0, 1, 1], output: [1] },
    { input: [1, 1, 1, 1, 0, 0], output: [0] },
    { input: [1, 1, 1, 1, 0, 1], output: [1] },
    { input: [1, 1, 1, 1, 1, 0], output: [1] },
